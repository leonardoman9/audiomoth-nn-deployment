...
/* NN optimization: disable GPS to save ~9KB Flash */
#define DISABLE_GPS_MODULE

/* NN optimization: disable USB debugging features to save ~15KB Flash */
#define DISABLE_USB_DEBUG_FEATURES

/* NN optimization: disable optional features to save RAM */
#define DISABLE_SD_CARD_FUNCTIONS           // Save ~3KB RAM
#define DISABLE_BATTERY_MONITORING          // Save ~1KB RAM  
#define DISABLE_TIMESTAMP_FUNCTIONS         // Save ~2KB RAM
